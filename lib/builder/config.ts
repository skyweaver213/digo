...
export interface Config {
     ...
     * 允许输出的最低日志等级。
     */
    logLevel?: typeof logging.logLevel | "verbose" | "log" | "info" | "success" | "failure" | "warning" | "error" | "fatal" | "slient";
     ...
     * 允许输出的最大日志长度。0 表示不限制。
     */
    maxMessageLength?: typeof logging.maxMessageLength;
     ...
     * 设置是否启用源映射。
     */
    sourceMap?: string | typeof file.sourceMap;
    ...
    for (const key in configs) {
        ...
        switch (key) {
            ...
            case "maxMessageLength":
                logging.maxMessageLength = value;
                break;
            case "logSource":
            ...
            case "sourceMap":
                if (typeof value === "string") {
                    ...
                    file.sourceMap = file => !file.generated && matcher.test(file.srcPath!);
                    break;
                }
