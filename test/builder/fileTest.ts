...
export namespace fileTest {
    ...
    export function generatedTest() {
        assert.equal(new file.File("foo/src.js", "foo").generated, false);
        assert.equal(new file.File().generated, true);
    }
