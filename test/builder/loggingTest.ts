...
export namespace loggingTest {
    ...
    export function logEntryMessageTest() {
        ...
        assert.equal(new logging.LogEntry({ error: new String("Sample Error") }).message, "Sample Error");
        ...
        assert.equal(new logging.LogEntry({ error: "Sample Error" }).message, "Sample Error");
    ...
    export function logEntryToStringTest() {
        assert.equal(new logging.LogEntry(undefined).toString(), "undefined");
        assert.equal(new logging.LogEntry("Sample Error").toString(), "Sample Error");
        assert.equal(new logging.LogEntry({ error: new String("Sample Error") }).toString(), "Sample Error");
        ...
        assert.equal(new logging.LogEntry({ message: "Sample Error", fileName: "foo.js", startLine: 0 }).toString(), "foo.js(1): Sample Error");
        assert.equal(new logging.LogEntry({ message: "Sample Error", fileName: "foo.js", startLine: 0, startColumn: 0 }).toString(), "foo.js(1,1): Sample Error");
