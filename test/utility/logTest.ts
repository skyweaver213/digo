...
export namespace logTest {
	...
	export function formatLogTest() {
		...
		assert.equal(log.formatLog("{A}", {}), "\u001b[1mA\u001b[39m");
		assert.equal(log.formatLog("{red:A}", {}), "\u001b[31mA\u001b[39m");

		assert.equal(log.formatLog("abc{a}", { a: 1, b: 2 }), "abc\u001b[1m1\u001b[39m");
		assert.equal(log.formatLog("abc{red:a}", { a: 1, b: 2 }), "abc\u001b[31m1\u001b[39m");

		assert.equal(log.formatLog("{a}", { a: "A" }), "\u001b[1mA\u001b[39m");
		assert.equal(log.formatLog("{a}{b}", { a: "A", b: "B" }), "\u001b[1mA\u001b[39m\u001b[1mB\u001b[39m");
		assert.equal(log.formatLog("{0}{1}", ["A", "B"]), "\u001b[1mA\u001b[39m\u001b[1mB\u001b[39m");
	}
